...
final class ConfirmTermViewController: BaseViewController {
    private lazy var confirmTableView: ConfirmTermTableView = {
        ...
        v.dataSource = self
        v.delegate = self
        v.register(ConfirmTermTableViewHeader.self, forHeaderFooterViewReuseIdentifier: ConfirmTermTableViewHeader.identifier)
    ...
    public override func viewDidLoad() {
        ...
        confirmTableView.register(ConfirmTermTableViewHeader.self, forHeaderFooterViewReuseIdentifier: ConfirmTermTableViewHeader.identifier)
