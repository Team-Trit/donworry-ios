...
extension User {
    static let dummyUser1: User = {
        .init(
            id: 1,
            nickName: "우디",
            bankAccount: .init(bank: .bankTOSS, accountHolderName: "이재용", accountNumber: "1000-1831-4124"),
    ...
    static let dummyUser2: User = {
        .init(
            id: 2,
            nickName: "에이브리",
            bankAccount: .init( bank: .bankTOSS, accountHolderName: "정찬희",  accountNumber: "1000-1831-4124"),
    ...
    static let dummyUser3: User = {
        .init(
            id: 3,
            nickName: "애셔",
            bankAccount: .init(bank: .bankCITI, accountHolderName: "임영후", accountNumber: "3000-2183-182723"),
    ...
    static let dummyUser4: User = {
        .init(
            id: 4,
            nickName: "유스",
            bankAccount: .init(bank: .bankCITI, accountHolderName: "김의성", accountNumber: "2000-2183-182723"),
    ...
    static let dummyUser5: User = {
        .init(
            id: 5,
            nickName: "찰리",
            bankAccount: .init(bank: .bankCITI, accountHolderName: "김승창", accountNumber: "4000-9732-893621"),
